...
(function () {
  const OPENAI_CHAT = [
    ...
    ["gpt-5.4", "general"],
    ["gpt-5", "previous flagship"], ["gpt-5-mini", "fast previous-gen"], ["gpt-5-nano", "cheapest previous-gen"], ["gpt-5-pro", "previous-gen pro"],
    ["gpt-5.1", "refined GPT-5"],
    ["gpt-5.2-2025-12-11", "dated general"], ["gpt-5.2-pro-2025-12-11", "dated pro"],
    ["gpt-4o", "multimodal workhorse"], ["gpt-4o-mini", "cheap workhorse"],
    ["gpt-4.1", "reliable coding"], ["gpt-4.1-mini", "fast coding"], ["gpt-4.1-nano", "cheapest coding"],
    ["o1", "reasoning"], ["o3", "reasoning"], ["o3-mini", "cheap reasoning"], ["o3-pro", "top reasoning"], ["o4-mini", "fast reasoning"],
  ...
  const COST = {
    ...
    "gpt-5.2": "$", "gpt-5.2-2025-12-11": "$", "gpt-5.2-pro-2025-12-11": "$$$",
    "gpt-5": "$$", "gpt-5-mini": "$", "gpt-5-nano": "$", "gpt-5-pro": "$$$",
    "gpt-5.1": "$$",
    "gpt-4o": "$", "gpt-4o-mini": "$", "gpt-4.1": "$", "gpt-4.1-mini": "$", "gpt-4.1-nano": "$",
    "o1": "$$", "o3": "$$", "o3-mini": "$", "o3-pro": "$$$", "o4-mini": "$",
    "openai/gpt-5.3-codex": "$$", "openai/gpt-oss-120b": "$", "gpt-oss-120b-250805": "$",
  ...
  const FAMILIES = [
    ...
    { id: "opus", name: "Opus", vendor: "Claude", desc: "Heaviest Claude reasoning", low: "claude-opus-4-8", high: "claude-opus-5" },
    ...
    { id: "gpt5", name: "GPT-5", vendor: "OpenAI", desc: "Previous flagship generation", low: "gpt-5-nano", high: "gpt-5-pro" },
    { id: "gpt51", name: "GPT-5.1", vendor: "OpenAI", desc: "Refined GPT-5", single: "gpt-5.1" },
    { id: "gpt52", name: "GPT-5.2", vendor: "OpenAI", desc: "Long-context generalist", low: "gpt-5.2", high: "gpt-5.2-pro-2025-12-11" },
    { id: "gpt4o", name: "GPT-4o", vendor: "OpenAI", desc: "Proven multimodal workhorse", low: "gpt-4o-mini", high: "gpt-4o" },
    { id: "gpt41", name: "GPT-4.1", vendor: "OpenAI", desc: "Reliable coding generation", low: "gpt-4.1-nano", high: "gpt-4.1" },
    { id: "o", name: "O-series", vendor: "OpenAI", desc: "Pure reasoning models", low: "o3-mini", high: "o3-pro" },
  ];
